        ...
        <div className="order-1 lg:order-2 grid grid-cols-2 gap-4 md:gap-6 mt-8 lg:mt-0">
          ...
          <div className="space-y-4 md:space-y-6 mt-12 md:mt-24">
            <img
              ...
              className="rounded-3xl object-cover w-full h-[180px] md:h-[260px] shadow-lg hover:scale-[1.02] transition-transform duration-500"
            ...
            <img
              ...
              className="rounded-3xl md:rounded-[2.5rem] object-cover w-full h-[280px] md:h-[460px] shadow-lg hover:scale-[1.02] transition-transform duration-500"
          ...
          <div className="space-y-4 md:space-y-6">
            <img
              ...
              className="rounded-3xl md:rounded-[3rem] object-cover w-full h-[320px] md:h-[500px] shadow-lg hover:scale-[1.02] transition-transform duration-500"
            ...
            <img
              ...
              className="rounded-3xl object-cover w-full h-[160px] md:h-[220px] shadow-lg hover:scale-[1.02] transition-transform duration-500"
