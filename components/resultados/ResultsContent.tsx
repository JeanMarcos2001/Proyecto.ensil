    ...
    <div className="w-full bg-paper-texture text-slate-800 font-jakarta">
      <main className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-blue-700 p-8 rounded-3xl text-white relative overflow-hidden group hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="font-medium text-blue-100 relative z-10">Graduados Exitosos</p>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-blue-50 rounded-full"></div>
            <h3 className="text-5xl font-bold text-slate-900 mb-2">95<span className="text-blue-700 text-3xl align-top">%</span></h3>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <span className="material-icons-round text-blue-700 text-3xl mb-2">location_on</span>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <span className="material-icons-round text-blue-700 text-3xl mb-2">history</span>
            <h3 className="text-5xl font-bold text-slate-900 mb-2">20<span className="text-blue-700 text-3xl align-top">+</span></h3>
        ...
        <div className="space-y-8">
          <div className="flex flex-col md:flex-row justify-between items-end gap-4">
            ...
            <button className="flex items-center gap-2 text-blue-700 font-bold hover:gap-4 transition-all group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:h-[500px]">
            ...
            <div className="relative rounded-3xl overflow-hidden group shadow-md bg-white p-6 flex flex-col justify-between">
              <div className="flex justify-between items-start">
                <span className="material-icons-round text-blue-700 bg-blue-100 p-2 rounded-xl">emoji_events</span>
              </div>
              <div>
          ...
          <div className="flex flex-col md:flex-row gap-6 overflow-x-auto pb-4 snap-x">
            ...
            <div className="min-w-[300px] md:min-w-[350px] flex-1 bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 snap-center relative">
              ...
              <p className="text-slate-600 mb-6 relative z-10">
                "Pensé que leer rápido significaba perder comprensión, pero ENSIL me demostró lo contrario. Ahora leo un libro por semana manteniendo el 100% de retención."
              </p>
              <div className="bg-blue-50 p-4 rounded-2xl flex items-center justify-between">
                <div>
                  <p className="text-xs text-slate-500">Velocidad final</p>
                  <p className="text-lg font-bold text-slate-900">1,200 ppm</p>
                </div>
                <div className="h-8 w-px bg-slate-200"></div>
                <div>
                  <p className="text-xs text-slate-500">Comprensión</p>
            ...
            <div className="min-w-[300px] md:min-w-[350px] flex-1 bg-blue-700 text-white p-8 rounded-[2rem] shadow-lg snap-center relative transform md:-translate-y-2">
              ...
              <p className="text-blue-50 mb-6 relative z-10">
                "La carga de lectura en mi carrera era abrumadora. ENSIL no solo me ahorró tiempo, sino que me dio la confianza para destacar en mis exámenes."
              </p>
              <div className="bg-white/10 backdrop-blur-sm p-4 rounded-2xl flex items-center justify-between border border-white/10">
                <div>
                  <p className="text-xs text-blue-200">Velocidad final</p>
                  <p className="text-lg font-bold text-white">2,400 ppm</p>
                </div>
                <div className="h-8 w-px bg-white/20"></div>
                <div>
                  <p className="text-xs text-blue-200">Comprensión</p>
            ...
            <div className="min-w-[300px] md:min-w-[350px] flex-1 bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 snap-center relative">
              ...
              <p className="text-slate-600 mb-6 relative z-10">
                "Necesitaba procesar informes rápidamente en el trabajo. La técnica es increíblemente efectiva y los resultados se notan desde la primera semana."
              </p>
              <div className="bg-blue-50 p-4 rounded-2xl flex items-center justify-between">
                <div>
                  <p className="text-xs text-slate-500">Velocidad final</p>
                  <p className="text-lg font-bold text-slate-900">950 ppm</p>
                </div>
                <div className="h-8 w-px bg-slate-200"></div>
                <div>
                  <p className="text-xs text-slate-500">Comprensión</p>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-7 gap-8">
              ...
              <div className="flex flex-col items-center text-center group relative">
                ...
                <div className="w-24 h-24 rounded-full bg-blue-50 flex items-center justify-center mb-4 group-hover:bg-blue-700 group-hover:text-white transition-colors duration-300 text-blue-700 border-2 border-dashed border-blue-700">
        ...
        <div className="bg-slate-900 rounded-[2.5rem] p-8 md:p-16 text-center relative overflow-hidden">
          <div className="absolute top-0 left-0 w-64 h-64 bg-blue-700 rounded-full filter blur-[100px] opacity-30"></div>
