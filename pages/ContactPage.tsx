...
const ContactPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_#2E7D32_0%,_#14532d_40%,_#022c22_100%)] font-jakarta text-white selection:bg-ensil-gold selection:text-white flex flex-col">
